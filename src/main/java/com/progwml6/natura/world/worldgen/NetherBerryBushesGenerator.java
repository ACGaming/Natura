...
{
    public static final NetherBerryBushesGenerator INSTANCE = new NetherBerryBushesGenerator();
    ...
    public void generateNether(Random random, int chunkX, int chunkZ, World world)
    {
        ...
        if (this.shouldGenerateInDimension(world.provider.getDimension()) && world.provider.doesWaterVaporize())
        {
