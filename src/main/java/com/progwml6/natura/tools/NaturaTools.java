...
public class NaturaTools extends NaturaPulse
{
    ...
    public void registerItems(Register<Item> event)
    {
        ...
        if (isNetherLoaded())
        {
            ...
            ghostwoodBow = registerItem(registry, new ItemNaturaBow(584, ghostwoodBow), "ghostwood_bow");
            ...
            bloodwoodBow = registerItem(registry, new ItemNaturaBow(584, bloodwoodBow), "bloodwood_bow");
            ...
            darkwoodBow = registerItem(registry, new ItemNaturaBow(584, darkwoodBow), "darkwood_bow");
            ...
            fusewoodBow = registerItem(registry, new ItemNaturaBow(584, fusewoodBow), "fusewood_bow");
